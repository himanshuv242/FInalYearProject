                ...
                renderItem={({item, index}) => {
                  return (
                    <TouchableOpacity
                      style={[
                        styles.languageItem,
                        {borderColor: item.selected == true ? '#0AC4BA' : 'black'},
                      ]}
                      onPress={() => {
                        onSelect(index);
                      }}>
                      {item.selected == true ? (
                        <Image
                          ...
                          style={[styles.icon, {tintColor: '#0AC4BA'}]}
                        />
                      ) : (
                        <Image
                          source={require('../assets/icons/non_selected.png')}
                          style={styles.icon}
                        />
                      )}
                      ...
                      <Text
                        style={{
                          marginLeft: 20,
                          fontSize: 18,
                          color: item.selected == true ? '#0AC4BA' : 'black',
                        }}>
                        {item.name}
                      </Text>
                    </TouchableOpacity>
